...
export default class Register extends React.Component {
    ...
    submitData = (e) => {
        ...
        fetch("http://localhost:8080/registeruser", reqOptions)
            .then(res => res.json())
            ...
            <div>
                ...
                <form class="form-vertical">
                    <table>
                        ...
                        <tr>
                            <td> Enter Mobile No.: </td><td> <input type="number" name="mobile" onChange={this.handleChange} /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Enter Passsword : </td><td> <input type="text" name="password" onChange={this.handleChange} /></td></tr>
